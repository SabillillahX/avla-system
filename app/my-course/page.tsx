                  ...
                  <CardContent className="p-5 flex flex-col flex-1">
                    ...
                    <div className="mt-auto space-y-3 pt-3 border-t border-gray-100 dark:border-gray-800">
                      ...
                      {course.relevantBatch && (
                        <div className={`flex items-start gap-1.5 text-[10px] sm:text-[11px] px-2.5 py-1.5 rounded-md ${course.isBatchExpired
                      ...
                      <div className="flex items-end justify-between">
                        ...
                        <Button
                          ...
                          className={`rounded-lg px-4 h-8 text-xs ${course.isBatchExpired
