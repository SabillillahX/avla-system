...
import { ArrowLeft, CheckCircle2, XCircle, Loader2, BookOpen, Clock, AlertCircle, Sparkles } from "lucide-react"
    ...
    const fetchResults = async () => {
      try {
        ...
        const [quizRes, assessmentRes] = await Promise.all([
          api.get("/quiz-results?per_page=50"),
          api.get("/question-answers?per_page=50")
        ])
